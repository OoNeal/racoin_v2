...
#[AllowDynamicProperties] class ObjetControlleur
{
     ...
     * @return array
     */
    public function formatterTableau($array): array
    {
        /*
     ...
     * @return array
     */
    public function estChampVide($array): array
    {
        $errors = [];
     ...
     * @return false|int
     */
    public function estEmail(string $email): false|int
    {
     ...
     * @return void
     */
    public function afficherErreurs($twig, $menu, $chemin, $errors)
    {
     ...
     * @return Annonce
     */
    public function CreerHtmlEntites(array $array, Annonce $annonce): Annonce
    {
        foreach ($array as $key => $value) {
